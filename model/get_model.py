...
def get_model(algorithm,dataset_name,device):
    ...
    if (algorithm == 'DPSGD') or (algorithm == 'DPSGD-Comp') or (algorithm == 'DPAGD') or (algorithm == 'DPAGD-Comp'):
...
def get_MIA_model(algorithm,dataset_name,device):
    ...
    if (algorithm == 'DPSGD') or (algorithm == 'DPSGD-Direct') or (algorithm == 'DPSGD-Comp'):
        if dataset_name == 'MNIST' or dataset_name == 'FMNIST':
