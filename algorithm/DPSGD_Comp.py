...
# def DPSGD_Comp(train_data, test_data, model, optimizer, batch_size, iteration_times, index, device):
#
...
def DPSGD_Comp(train_data, test_data, model, optimizer, privacy_params, batch_size, iteration_times, index, device):
